...
const clientBank = {
  [clientBankSymbol]: 'Горбатенко Валерий',
  accountNumber: 88781841,
  balance: 0,
};
const clinicWorker = {
  [clinicWorkerSymbol]: 'Чораев Ярослав',
  speciality: 'bs',
  employeeID: 4864654,
};
const citizenRF = {
  [citizenRFSymol]: 'Худов Евгений',
  passportNumber: '1118 784556',
  address: 'г. Москва, ул. Пельмени, д. 25',
};
...
const phoneNumber = "YourPhoneNumberHere"; 
