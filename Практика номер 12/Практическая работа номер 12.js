...
console.log(age);
const children = [
   {name: 'Jazz', age:18, isAdmin: true },
   {name: 'Valera', age:16, isAdmin: false },
   {name: 'Gesha', age:26, isAdmin: true },
   {name: 'Yarik', age:24, isAdmin: true },
   {name: 'Anton', age:14, isAdmin: false }
];
...
if (admin) {
  ...
  console.log(fullage);
  const students = [
    { name: 'Jazz', scores: [5, 4, 3] },
    { name: 'Valera', scores: [4, 4, 5] },
    { name: 'Yarik', scores: [3, 3, 3] }
  ];
